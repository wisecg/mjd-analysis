...
void FindThresholds(int run)
{
  string outputFile = Form("./thresh_%i.root",run);
  ...
  // Assumes the data has been moved already
  // but only pass-1 gat data exists
  GATDataSet ds(run);
