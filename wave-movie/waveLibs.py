...
def H2D(tree,nameStr,xbins,xlo,xhi,ybins,ylo,yhi,drawStr,cutStr):
    h1 = TH2D(nameStr,nameStr,xbins,xlo,xhi,ybins,ylo,yhi)
    tree.Project(nameStr,drawStr,cutStr)
    return h1
