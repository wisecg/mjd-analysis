...
def main(argv):
    """
	Makes movies of waveforms that pass a TCut.
	Clint Wiseman, USC.
    ...
    gatFile = TFile("~/project/mjddatadir/gatified/mjd_run27016.root") # generate w/ process_mjd_data_p1
    bltFile = TFile("~/project/mjddatadir/built/OR_run27016.root")
